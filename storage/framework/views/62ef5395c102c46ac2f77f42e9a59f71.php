<?php $__env->startComponent('admin::emails.layout'); ?>
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            <?php echo e(__('admin::app.emails.dear', ['customer_name' => $invoice->order->customer_full_name])); ?>,👋
        </p>
...
<?php /**PATH D:\Documentos\NewGitHub\SistemaVentaWeb_Laravel\packages\Webkul\Admin\src/resources/views/emails/orders/invoiced.blade.php ENDPATH**/ ?>