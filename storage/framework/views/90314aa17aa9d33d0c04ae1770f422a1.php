<?php $__env->startComponent('admin::emails.layout'); ?>
    <div style="margin-bottom: 34px;">
        <span style="font-size: 22px;font-weight: 600;color: #121A26">
            <?php echo e(__('admin::app.emails.orders.inventory-source.title')); ?>

        </span> <br>

        <p style="font-size: 16px;color: #5E5E5E;line-height: 24px;">
            <?php echo e(__('admin::app.emails.dear', ['admin_name' => $shipment->inventory_source->contact_name])); ?>,👋
        </p>
    ...
    <div style="font-size: 20px;font-weight: 600;color: #121A26">
        <?php echo e(__('admin::app.emails.orders.inventory-source.summary')); ?>
...
<?php /**PATH D:\Documentos\NewGitHub\SistemaVentaWeb_Laravel\packages\Webkul\Admin\src/resources/views/emails/orders/inventory-source.blade.php ENDPATH**/ ?>