<v-media <?php echo e($attributes); ?> >
    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => ['class' => 'w-[284px] h-[284px] mt-[30px] rounded-[12px]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-[284px] h-[284px] mt-[30px] rounded-[12px]']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (! $__env->hasRenderedOnce('0c7d9f14-6b54-4d70-9370-c98fdd67ea4f')): $__env->markAsRenderedOnce('0c7d9f14-6b54-4d70-9370-c98fdd67ea4f');
        ...
        <div class="flex flex-col mb-4 rounded-lg cursor-pointer">
            <div :class="{'border border-dashed border-gray-300 dark:border-gray-800 rounded-[18px]': isDragOver }">
                ...
                >
                    ...
                    >
                        <?php echo app('translator')->get('shop::app.components.media.add-attachments'); ?>
                    </label>
...
<?php /**PATH D:\Documentos\NewGitHub\SistemaVentaWeb_Laravel\packages\Webkul\Shop\src/resources/views/components/media/index.blade.php ENDPATH**/ ?>