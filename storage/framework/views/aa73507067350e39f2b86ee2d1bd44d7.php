...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.media.images.lazy','data' => ['class' => 'max-w-[110px] max-h-[110px] min-w-[110px] w-[110px] h-[110px] rounded-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'max-w-[110px] max-h-[110px] min-w-[110px] w-[110px] h-[110px] rounded-sm']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (! $__env->hasRenderedOnce('b5ccd8d9-4c53-48dd-ab30-5620be75b6e7')): $__env->markAsRenderedOnce('b5ccd8d9-4c53-48dd-ab30-5620be75b6e7');
            ...
            <div class="flex gap-[46px]">
                ...
                <div class="flex flex-col gap-[15px]">
                    <h2 class="text-[26px] font-medium">
                        <?php echo app('translator')->get('shop::app.search.images.results.analysed-keywords'); ?>
                    </h2>
...
<?php $__env->stopPush(); endif; ?><?php /**PATH D:\Documentos\NewGitHub\SistemaVentaWeb_Laravel\packages\Webkul\Shop\src/resources/views/search/images/results.blade.php ENDPATH**/ ?>