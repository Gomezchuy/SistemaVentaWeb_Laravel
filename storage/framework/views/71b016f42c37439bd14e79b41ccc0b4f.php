...
<?php $component->withAttributes([]); ?>
    ...
    <?php if (! $__env->hasRenderedOnce('e3a51c38-d432-4c49-ba1a-690b52cdf733')): $__env->markAsRenderedOnce('e3a51c38-d432-4c49-ba1a-690b52cdf733');
            ...
            app.component('v-notification-list',{
                ...
                data() {
                    return {
                        ...
                        orderStatus: {
                            all: "<?php echo app('translator')->get('admin::app.notifications.status.all'); ?>",
                            pending: "<?php echo app('translator')->get('admin::app.notifications.status.pending'); ?>",
                            canceled: "<?php echo app('translator')->get('admin::app.notifications.status.canceled'); ?>",
                            closed: "<?php echo app('translator')->get('admin::app.notifications.status.closed'); ?>",
                            completed: "<?php echo app('translator')->get('admin::app.notifications.status.completed'); ?>",
                            processing: "<?php echo app('translator')->get('admin::app.notifications.status.processing'); ?>" 
                        },
                ...
                methods: {
                    ...
                    getResults(page = 1) {
                        axios.get(`${"<?php echo e(route('admin.notification.get_notification')); ?>"}?page=${page}`)
                            .then(response => {
                                this.notifications = [];
...
<?php endif; ?><?php /**PATH D:\Documentos\NewGitHub\SistemaVentaWeb_Laravel\packages\Webkul\Admin\src/resources/views/notifications/index.blade.php ENDPATH**/ ?>