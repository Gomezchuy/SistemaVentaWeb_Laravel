<?php if($product->type == 'bundle'): ?>
    ...
    <?php if (! $__env->hasRenderedOnce('f4027e22-c57d-49fa-b211-67cd7bfb5fe9')): $__env->markAsRenderedOnce('f4027e22-c57d-49fa-b211-67cd7bfb5fe9');
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'shop::components.quantity-changer.index','data' => [':name' => '\'bundle_option_qty[\' + option?.id + \']\'',':value' => 'productQty','class' => 'gap-x-[16px] w-max rounded-[12px] py-[10px] px-[17px] mt-5 !border-[#E9E9E9]','@change' => 'qtyUpdated($event)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes([':name' => '\'bundle_option_qty[\' + option?.id + \']\'',':value' => 'productQty','class' => 'gap-x-[16px] w-max rounded-[12px] py-[10px] px-[17px] mt-5 !border-[#E9E9E9]','@change' => 'qtyUpdated($event)']); ?>
...
<?php endif; ?>
<?php /**PATH D:\Documentos\NewGitHub\SistemaVentaWeb_Laravel\packages\Webkul\Shop\src/resources/views/products/view/types/bundle.blade.php ENDPATH**/ ?>